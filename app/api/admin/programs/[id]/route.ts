...
export async function PATCH(
  ...
  const { title, description, target_audience, process_description, duration_minutes, notice, pending_sms, confirmation_sms } = body
  ...
  if (pending_sms !== undefined) updates.pending_sms = pending_sms
